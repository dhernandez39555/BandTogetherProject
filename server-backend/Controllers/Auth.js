...
router.post("/register", async (req, res) => {
    try {
    const { profilePicture, coverPhoto, email, password, bandName, contactName, location, latitude, longitude, genre,
    ...
    const newUser = new User({ profilePicture, coverPhoto, email, password: bcrypt.hashSync(password, SALT), 
